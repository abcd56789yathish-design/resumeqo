...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    else if (err === "unknown") setError("Something went wrong. Please try again.");
  }, []);
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--paper)] px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[var(--paper-card)] rounded-2xl shadow-sm border border-[var(--line)] p-8">
          <h1 className="text-2xl font-semibold text-[var(--ink)] mb-1">Welcome back</h1>
          <p className="text-sm text-[var(--ink-soft)] mb-8">Sign in to your account to continue.</p>
          ...
          <p className="text-center text-sm text-[var(--ink-soft)] mt-6">
            ...
            <Link href="/signup" className="text-[var(--coral)] font-medium hover:underline">Create one</Link>
          </p>
        </div>
      </div>
    </div>
